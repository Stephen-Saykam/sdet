...
/**
 * Create purchase Order & Select the Status As Created
 * @author stephen
 *
 */

public class CreatePO_StatusAsCreatedTest extends BaseClass {
	
	@Test
	public void createPO_StatusAsCreatedTest() throws Throwable
	{
